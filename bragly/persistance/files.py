...
def write(message, file_path=None, file_dir=None, form='json'):
    ...
    Args:
        ...
        file_path (str): The file path for the source file. If None, the file_path will be generated from the file_dir
            and the form
        file_dir (str): The file directory for the source file. If None, the file_path will be used
...
def _get_file_path(form, file_path=None, file_dir=None):
    """Given a format, and either a filepath or file directory, returns the proper filepath.
        The format of the file, if dynamically generated from the file_dir will be:
            /path/to/file/dir/brag-{format}.dat
    Args:
        form (str): A message format, one of log, json, json-pretty
        file_path (str): The file path for the source file. If None, the file_path will be generated from the file_dir
            and the form
...
def _parse_line(line, form):
    """Parse a message line according to the form that is passed in, returning a ParsedLine object.

    Args:
        line (str): A line from the data file
        form (str): Indicates the form that the line is in, one of log or json (json-pretty not supported)
...
def _coerce_line(parsed_line, out_form):
    ...
    Returns:
        str: The line in the format requested
        ParsedLine: Passthrough of the parsed_line arg, if requested
    """
...
def search(start, end, out_form, tags, text, all_args, form, file_dir=None, file_path=None):
    """Given a file path or a file directory and form, searches the files according to the search parameters.
    ...
    Args:
        ...
        all_args (bool): Indicates whether all tags and text must exist for the message to be surfaces
        form (str): The format that the source file is in
        file_dir (str): The file directory for the source file. If None, the file_path will be used.
        file_path (str): The file path for the source file. If None, the file_path will be generated from the file_dir
            and the form.
